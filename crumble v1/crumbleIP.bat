...
chcp 65001
cls
title NulBerry IP Lookup Tool ~Designed For [%APP%]~
color 05
mode 60,15
...
echo        [40;32m2) Locate a Server / Device Using IP Address
goto action
:input
echo.
...
for /f "delims= 	" %%i in ('findstr /i "ip hostname city region country loc org postal" %temp%\response.txt') do (
	...
	set data=!data:"=!
	set data=!data:ip:=[40;32mIP:		!
	set data=!data:hostname:=[40;37mHostname:	!
	set data=!data:city:=[40;32mCity:		!
	set data=!data:region:=[40;37mState:	!
	set data=!data:country:=[40;32mCountry:	!
	set data=!data:loc:=[40;37mLocation:	!
	set data=!data:org:=[40;32mISP:		!
